...
import {
  ...
  clearCauseState,
} from "@/modules/escalation/slices/causeSlice";
import {
  Table,
  TableBody,
  TableCell,
...
function CauseDashboard() {
  ...
  useEffect(() => {
    ...
    if (submittedData) {
      toast.success(
       "Cause status updated successfully!"
   );
    }
  }, [error, submittedData]);
  ...
  return (
    <div className="w-full min-h-[80vh]">
      <div className="bg-white rounded-xl shadow-xl ">
        {/* Header */}
        <div className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-t-xl p-2">
