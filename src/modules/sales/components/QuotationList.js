...
import { getQuotations, getQuotationById, getClientStatusByQuotationId } from "@/modules/sales/slices/quotationSlice";
import {
  Table,
  TableHeader,
  TableRow,
...
// console.log("Selected Quotation clientStatus:", clientStatus);
  ...
  const handleEditQuotation = (quotationNumber) => {
    router.push(`/sales/quotation/edit/${quotationNumber}`);
  };
